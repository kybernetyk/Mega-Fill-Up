...
@synthesize glView;
@synthesize moneyViewContainerView;
...
- (void)viewDidLoad 
{
	...
	if (!moneyViewController)
	{
		moneyViewController = [[MoneyViewController alloc] initWithNibName: @"MoneyViewController" bundle: nil];
		[moneyViewController setSuperViewController: self];
		[[self moneyViewContainerView] addSubview: [moneyViewController view]];
	}
