...
//	[[BCAchievementNotificationCenter defaultCenter] notifyWithTitle:@"Fail!" message: nil image: [UIImage imageNamed: @"disapproval_icon.png"]];
...
//	[[BCAchievementNotificationCenter defaultCenter] notifyWithTitle:@"Aweome!" message:@"But this level was easy xD" image: [UIImage imageNamed: @"awesome_face_icon.png"]];
